...
class Nexista_Flow
{
        ...
        for ($i = 0; $i < strlen($params['request']); $i ++) {
            ...
            case 'G':
                ...
                if (!is_null(self::$_importHandler)) {
                    $ref = $this->add('_get',
                        call_user_func(self::$_importHandler, $_GET));
                } else {
            ...
            case 'P':
                if (!is_null(self::$_importHandler)) {
                    $ref = $this->add('_post',
                        call_user_func(self::$_importHandler, $_POST));
                } else {
            ...
            case 'F':
                if (!is_null(self::$_importHandler)) {
                    $ref = $this->add('_files',
                        call_user_func(self::$_importHandler, $_FILES));
                } else {
            ...
            case 'S':
                if (!is_null(self::$_importHandler)) {
                    $ref = $this->add('_session',
                        call_user_func(self::$_importHandler, $_SESSION));
                } else {
            ...
            case 'V':
                if (!is_null(self::$_importHandler)) {
                    $ref = $this->add('_server',
                        call_user_func(self::$_importHandler, $_SERVER));
                } else {
            ...
            case 'E':
                if (!is_null(self::$_importHandler)) {
                    $ref = $this->add('_env',
                        call_user_func(self::$_importHandler, $_ENV));
                } else {
            ...
            case 'W':
                if (!is_null(self::$_importHandler)) {
                    $ref = $this->add('_globals',
                        call_user_func(self::$_importHandler, $GLOBALS));
                } else {
     ...
     *
     * @param string $exp    xpath expression
     * @param object $parent (optional) reference to parent node for relative
     * searches
     *
     ...
     *
     * @param object $node reference to flow var to delete
     *
     * @return null
     */
